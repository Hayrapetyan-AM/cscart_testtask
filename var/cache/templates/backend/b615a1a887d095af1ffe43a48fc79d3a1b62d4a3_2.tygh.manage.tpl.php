<?php
/* Smarty version 4.3.0, created on 2024-12-28 11:09:03
  from '/home/armen/phpProjects/cscart/fidem_test_task/design/backend/templates/views/product_features/manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_67704ccfdbc403_21997490',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b615a1a887d095af1ffe43a48fc79d3a1b62d4a3' => 
    array (
      0 => '/home/armen/phpProjects/cscart/fidem_test_task/design/backend/templates/views/product_features/manage.tpl',
      1 => 1728377975,
      2 => 'tygh',
    ),
  ),
...
function content_67704ccfdbc403_21997490 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/armen/phpProjects/cscart/fidem_test_task/app/functions/smarty_plugins/function.script.php','function'=>'smarty_function_script',),1=>array('file'=>'/home/armen/phpProjects/cscart/fidem_test_task/app/functions/smarty_plugins/modifier.enum.php','function'=>'smarty_modifier_enum',),2=>array('file'=>'/home/armen/phpProjects/cscart/fidem_test_task/app/lib/vendor/smarty/smarty/libs/plugins/modifier.explode.php','function'=>'smarty_modifier_explode',),3=>array('file'=>'/home/armen/phpProjects/cscart/fidem_test_task/app/functions/smarty_plugins/modifier.to_json.php','function'=>'smarty_modifier_to_json',),4=>array('file'=>'/home/armen/phpProjects/cscart/fidem_test_task/app/functions/smarty_plugins/block.hook.php','function'=>'smarty_block_hook',),));
...
$_smarty_tpl->_assignInScope('href_edit', "product_features.update?feature_id=".((string)$_smarty_tpl->tpl_vars['p_feature']->value['feature_id']).$_prefixVariable1);?>
                                ...
                                <?php $_smarty_tpl->_assignInScope('feature_category_ids', $_smarty_tpl->tpl_vars['p_feature']->value['categories_path'] ? (smarty_modifier_explode(",",$_smarty_tpl->tpl_vars['p_feature']->value['categories_path'])) : (array()));?>
...
"<?php }?> class="row-status cm-external-click bulkedit-deselect link--monochrome <?php if ($_smarty_tpl->tpl_vars['non_editable']->value) {?> no-underline<?php }?>" data-ca-external-click-id="opener_group<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['p_feature']->value['feature_id'], ENT_QUOTES, 'UTF-8');?>
...
">
                                                <?php if ($_smarty_tpl->tpl_vars['group_feature']->value['status'] != "A") {?>
                                                    <?php $_smarty_tpl->_assignInScope('group_link_class', "link--monochrome row-status");?>
                                                <?php } else { ?>
                                                    <?php $_smarty_tpl->_assignInScope('group_link_class', "link--monochrome");?>
                                                <?php }?>
...
">
                                        <?php $_smarty_tpl->_subTemplateRender("tygh:common/select_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"product_features",'popup_additional_class'=>"dropleft",'id'=>$_smarty_tpl->tpl_vars['p_feature']->value['feature_id'],'status'=>$_smarty_tpl->tpl_vars['p_feature']->value['status'],'hidden'=>true,'object_id_name'=>"feature_id",'table'=>"product_features",'update_controller'=>"product_features"), 0, true);
?>
                                    </td>
                                </tr>
                            <?php
...
?>
        <?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
        <?php $_smarty_tpl->_subTemplateRender("tygh:common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('id'=>"add_new_feature",'text'=>$_smarty_tpl->__("new_feature"),'title'=>$_smarty_tpl->__("new_feature"),'link_text'=>$_smarty_tpl->__("new_feature"),'content'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'add_new_picker_2'),'act'=>"general",'icon'=>"icon-plus",'link_class'=>"btn-primary nav__actions-btn-primary"), 0, true);
?>
    <?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
